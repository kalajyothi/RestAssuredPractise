...
public class RestfulEcommerceE2ETests extends BaseTest {
    ...
    public void testCreateOrder() {
        ...
        assertThat(orderArray.getJSONObject(0).get("id"), notNullValue());
        orderId = orderArray.getJSONObject(0).getInt("id");

        OrderData orderData = orderList.get(0);
        assertThat(orderArray.getJSONObject(0).get("user_id"), equalTo(orderData.getUserId()));
        assertThat(orderArray.getJSONObject(0).get("product_id"), equalTo(orderData.getProductId()));
        assertThat(orderArray.getJSONObject(0).get("product_name"), equalTo(orderData.getProductName()));
        assertThat(orderArray.getJSONObject(0).get("product_amount"), equalTo(orderData.getProductAmount()));
        assertThat(orderArray.getJSONObject(0).get("qty"), equalTo(orderData.getQty()));
        assertThat(orderArray.getJSONObject(0).get("tax_amt"), equalTo(orderData.getTaxAmt()));
        assertThat(orderArray.getJSONObject(0).get("total_amt"), equalTo(orderData.getTotalAmt()));
    ...
    public void testGetAllOrders() {
        ...
        assertThat(orderArray.getJSONObject(0).get("id"), equalTo(orderId));
    ...
    public void updatePartialOrderTest() {
        ...
        OrderData orderData = getPartialOrder();
        String responseBody = given().when()
                .header("Authorization", token)
                .body(orderData)
        ...
        assertThat(orderObject.get("id"), equalTo(orderId));
        assertThat(orderObject.get("product_name"), equalTo(orderData.getProductName()));
        assertThat(orderObject.get("product_amount"), equalTo(orderData.getProductAmount()));
        assertThat(orderObject.get("qty"), equalTo(orderData.getQty()));
